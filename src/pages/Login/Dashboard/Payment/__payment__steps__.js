 ...
 * 5. create paymenttn intent post on the server and return client secret. 
 * install stripe on the server side and gget client secret. make sure you use the payment method types: ['card]
